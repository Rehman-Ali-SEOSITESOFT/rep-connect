...
const page = () => {
  ...
  const hanldeCheckBox = (e) => {
    setTagOrderField({ ...tagOrderField, [e.target.name]: e.target.checked });
  };
  setTimeout(() => {
    setErrorResponse(false);
              ...
              >
                <div className={`${style.first_section} row`}>
                  ...
                  >
                    ...
                    <input
                      ...
                      name="text"
                      type="text"
                      placeholder="Enter Phone Number as it will appear on cards"
                  ...
                  >
                    ...
                    <input
                      ...
                      name="email"
                      type="email"
                      placeholder="Enter Email as it will appear on cards"
                      value={tagOrderField.email}
                      onChange={hanldechange}
                    />
                    {errorResponse && (
                  ...
                  <div className={`col-lg-6 ${style.form_field} `}>
                    ...
                    <input
                      ...
                      name="text"
                      type="text"
                      placeholder="Enter Fax Number as it will appear on cards"
                    />
                  </div>
                </div>
                <div className={`${style.second_section} row`}>
                  <div className={`col-12 ${style.form_field}`}>
                    ...
                    <div
                      className={`${
                        tagOrderField.business_name
                          ? style.selected_applicable
                          : style.select_applicable
                      } `}
                    >
                      <input
                        type="checkbox"
                      ...
                      <label htmlFor="business_name">
                        I do not want my name on my business card
                      </label>
                    </div>
                    <div
                      className={`${
                        tagOrderField.business_title
                          ? style.selected_applicable
                          : style.select_applicable
                      } `}
                    >
                      ...
                      <label htmlFor="business_title">
                        I do not want my title on my business card
                      </label>
                    </div>
                    <div
                      className={`${
                        tagOrderField.business_phone
                          ? style.selected_applicable
                          : style.select_applicable
                      } `}
                    >
                      ...
                      <label htmlFor="business_phone">
                        I do not want my phone number on my business card
                      </label>
                    </div>
                    <div
                      className={`${
                        tagOrderField.business_email
                          ? style.selected_applicable
                          : style.select_applicable
                      } `}
                    >
                      ...
                      <label htmlFor="business_email">
                        I do not want my email on my business card
                      </label>
                    </div>
                    <div
                      className={`${
                        tagOrderField.business_fax
                          ? style.selected_applicable
                          : style.select_applicable
                      } `}
                    >
                      <input
                        ...
                        id="business_fax"
                        name="business_fax"
                        // value={tagOrderField.business_fax}
                        onChange={hanldeCheckBox}
                        // checked={tagOrderField.business_fax}
                      />
                      <label htmlFor="business_fax">
                        I do not want my fax number on my business card
                      </label>
                    </div>
                  </div>
                  <div className={`col-12 ${style.form_field}`}>
                ...
                >
                  <div className={`col-12 ${style.form_field}`}>
                    <h4 className={style.label__heading}>
                      Address you would like cards shipped to
                      <span>*</span>
                    </h4>
                  </div>
                  <div className={`col-12 ${style.form_field}`}>
