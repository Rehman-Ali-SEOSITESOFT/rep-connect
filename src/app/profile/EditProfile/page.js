                        ...
                        <form onSubmit={handleProfileSubmit}>
                            <div className={`accordion`} id="accordionExample">
                                                ...
                                                <div className={`row ${styles.profile_row}`}>
                                                    <div className="col-lg-4 col-md-12 p-1">
                                                        <div className={styles.label}>
                                                            ...
                                                            <span> <Image src={help} alt="logo" /> </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className={`row ${styles.profile_row}`}>
                                                    <div className="col-lg-4 col-md-12 p-2">
                                                        <div className={styles.profilePic}>
                                                            ...
                                                            <div className={styles.iconLabel} > <label> Facebook Page </label> </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-8 col-md-12 p-2">
                                                        <div>
                                                ...
                                                <div className={`row ${styles.profile_row}`}>
                                                    <div className="col-lg-4 col-md-12 p-2">
                                                        <div className={styles.profilePic}>
                                                            ...
                                                            <div className={styles.iconLabel}> <label> Twitter </label> </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-8 col-md-12 p-2">
                                                        <div>
                                                            <div>
                                                                <input onChange={handleChange} value={userProfile.twitter} name="twitter" className={`w-100 ${styles.input}`} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div className={styles.btns_row}>
                                    <button type='submit' className={styles.save_changes}> save changes </button> <button className={styles.upload_pic02} > Request Verification </button>
                                </div>
                            </div>
                        </form>
                    </div>
              ...
              <div className={styles.loginAreaDetails}>
                <div>
                  <Image
                    ...
                    alt="logo"
                  />
>>>>>>> b672a87bd42f5d7eae07b8cc6ee416686b671e11
                </div>
                <div>
                  <span className={styles.para}>grtesting</span>
                </div>
