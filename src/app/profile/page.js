              ...
              <div className='accordion__sho'>
                <div className="accordion" id="accordionPanelsStayOpenExample">
                  <div className="accordion-item">
                    ...
                    <div id="panelsStayOpen-collapseOne03" className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
                  ...
                  <div className='accordion__sho01'>
                    <div className="accordion" id="accordionPanelsStayOpenExample">
                      <div className={`accordion-item ${styles.ac_item}`}>
                        ...
                        <div id="panelsStayOpen-collapseOne02" className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
                          <div className="accordion-body">
                  ...
                  <div className='accordion__sho01'>
                    <div className="accordion" id="accordionPanelsStayOpenExample">
                      <div className={`accordion-item ${styles.ac_item}`}>
                        ...
                        <div id="panelsStayOpen-collapseOne01" className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
                          <div className="accordion-body">
                            <div>
                  ...
                  <div className={styles.expand_all}>
                    ...
                    >
                      {expand ?
                        ...
                        </span> : <span> <i className="fa-solid fa-angle-up"></i> </span>
                        }
                ...
                <div className="accordion" id="accordionExample">
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                      <button className={`accordion-button ac-btn  ${styles.acc_btn}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne-01" aria-expanded="true" aria-controls="collapseOne">
                        <div className={styles.circle_select}></div> <div> 1. Classroom Traning </div>
                      </button>
                    </h2>
                    <div id="collapseOne-01" className="accordion-collapse02 collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                      <button className={`accordion-button ac-btn ${styles.acc_btn}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne-02" aria-expanded="true" aria-controls="collapseOne">
                    ...
                    <div id="collapseOne-02" className="accordion-collapse02 collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className={`accordion-body ${styles.acc_body}`}>
                        <div className={styles.accord_body}>
                          <div className={styles.accord_body_alignment}>
                            <div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                      <button className={`accordion-button ac-btn ${styles.acc_btn}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne03" aria-expanded="true" aria-controls="collapseOne">
                    ...
                    <div id="collapseOne03" className="accordion-collapse02 collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className={`accordion-body ${styles.acc_body}`}>
                        <div className={styles.accord_body}>
                          <div className={styles.accord_body_alignment}>
                            <div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                      <button className={`accordion-button ${styles.acc_btn} ac-btn`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne04" aria-expanded="true" aria-controls="collapseOne">
                        <div className={styles.circle_select}></div> <div> 3. Microbiology Key Concepts </div>
                      </button>
                    </h2>
                    <div id="collapseOne04" className="accordion-collapse02 collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className={`accordion-body ${styles.acc_body}`}>
                        <div className={styles.accord_body}>
                          <div className={styles.accord_body_alignment}>
                            <div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                      <button className={`accordion-button ac-btn ${styles.acc_btn}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne05" aria-expanded="true" aria-controls="collapseOne">
                        <div className={styles.circle_select}></div> <div> 3. Sales Report Videos </div>
                      </button>
                    </h2>
                    <div id="collapseOne05" className="accordion-collapse02 collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className={`accordion-body ${styles.acc_body}`}>
                        <div className={styles.accord_body}>
                          <div className={styles.accord_body_alignment}>
                            <div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                      <button className={`accordion-button ac-btn ${styles.acc_btn}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne06" aria-expanded="true" aria-controls="collapseOne">
                        <div className={styles.circle_select}></div> <div> 4. Sales Material </div>
                      </button>
                    </h2>
                    <div id="collapseOne06" className="accordion-collapse02 collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className={`accordion-body ${styles.acc_body}`}>
                        <div className={styles.accord_body}>
                          <div className={styles.accord_body_alignment}>
                            <div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                      <button className={`accordion-button ac-btn ${styles.acc_btn}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne07" aria-expanded="true" aria-controls="collapseOne">
                        <div className={styles.circle_select}></div> <div> 4. Technology </div>
                      </button>
                    </h2>
                    <div id="collapseOne07" className="accordion-collapse02 collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className={`accordion-body ${styles.acc_body}`}>
                        <div className={styles.accord_body}>
                          <div className={styles.accord_body_alignment}>
                            <div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                      <button className={`accordion-button ac-btn ${styles.acc_btn}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne08" aria-expanded="true" aria-controls="collapseOne">
                        <div className={styles.circle_select}></div> <div> 5. MicroGenDX Minute </div>
                      </button>
                    </h2>
                    <div id="collapseOne08" className="accordion-collapse02 collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className={`accordion-body ${styles.acc_body}`}>
                        <div className={styles.accord_body}>
                          <div className={styles.accord_body_alignment}>
                            <div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                      <button className={`accordion-button ac-btn ${styles.acc_btn}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne09" aria-expanded="true" aria-controls="collapseOne">
                        <div className={styles.circle_select}></div> <div> 5. Science of MicroGenDX - Sales Training 2.1 </div>
                      </button>
                    </h2>
                    <div id="collapseOne09" className="accordion-collapse02 collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className={`accordion-body ${styles.acc_body}`}>
                        <div className={styles.accord_body}>
                          <div className={styles.accord_body_alignment}>
                            <div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                      <button className={`accordion-button ac-btn ${styles.acc_btn}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne10" aria-expanded="true" aria-controls="collapseOne">
                        <div className={styles.circle_select}></div> <div> 6. Understanding Clinical Papers </div>
                      </button>
                    </h2>
                    <div id="collapseOne10" className="accordion-collapse02 collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className={`accordion-body ${styles.acc_body}`}>
                        <div className={styles.accord_body}>
                          <div className={styles.accord_body_alignment}>
                            <div>
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                      <button className={`accordion-button ac-btn ${styles.acc_btn}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne11" aria-expanded="true" aria-controls="collapseOne">
                        <div className={styles.circle_select}></div> <div> 7. Business Development </div>
                      </button>
                    </h2>
                    <div id="collapseOne11" className="accordion-collapse02 collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className={`accordion-body ${styles.acc_body}`}>
                        <div className={styles.accord_body}>
                          <div className={styles.accord_body_alignment}>
                            <div>
