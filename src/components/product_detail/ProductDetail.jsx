              ...
              <div className="col-xl-9 col-md-8 col-12">
                <div className="deail--product--desc">
                  ...
                  <p>
                    ...
                    qualified* physician’s signature on the lab requisition form
                    or the submitted sample will not be run/processed at the
                    MicroGenDX Laboratory. To learn more
                    <a href="#">CLICK HERE</a>
                  </p>
